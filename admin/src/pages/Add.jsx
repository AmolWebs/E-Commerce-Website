            ...
            <div>
                ...
                <div className='flex gap-3' >
                    ...
                    <div onClick={() => setSizes(prev => prev.includes("Pink") ? prev.filter(item => item != "Pink") : [...prev, "Pink"])} >
                        <p className={`${sizes.includes("Pink") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`} >Pink</p>
                    </div>
                </div>
            </div>

            <div className='flex gap-2 mt-2' >
                <input onChange={() => prev = !prev} checked={bestseller} type="checkbox" id="bestseller" />
